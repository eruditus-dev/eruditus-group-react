...
const ClientsSection = () => {
  const clients = [
    ...
    { name: 'Solfluinco', logo: 'https://eruditus-assets.ams3.digitaloceanspaces.com/geomatrix.png' },
    { name: 'Guio', logo: 'hhttps://eruditus-assets.ams3.digitaloceanspaces.com/geomatrix.png' },
    { name: 'Chimeneas el chalet', logo: 'https://eruditus-assets.ams3.digitaloceanspaces.com/geomatrix.png' },
    { name: 'ACPEF', logo: 'https://eruditus-assets.ams3.digitaloceanspaces.com/geomatrix.png' },
    { name: 'Ligautismo', logo: 'https://eruditus-assets.ams3.digitaloceanspaces.com/geomatrix.png' },
    ...
    { name: 'Interior Vision Designs', logo: 'https://eruditus-assets.ams3.digitaloceanspaces.com/geomatrix.png' },
    { name: '+Medicos', logo: 'https://eruditus-assets.ams3.digitaloceanspaces.com/geomatrix.pngg' },
